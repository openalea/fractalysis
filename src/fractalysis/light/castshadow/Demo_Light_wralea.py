...
# This file has been generated at Wed Jun 18 00:08:11 2008
...
__all__ = ['scalesTable', 'MuSLIM', '_146603564']
...
MuSLIM = CompositeNodeFactory(name='MuSLIM', 
   ...
   32: ('system', 'annotation')},
                             elt_connections={  135712524: (26, 0, 8, 2),
   135712536: (5, 0, 14, 0),
   135712548: (29, 0, 8, 1),
   135712560: (5, 0, 6, 1),
   135712572: (7, 0, 6, 0),
   ...
   6: [(3, "'Cvx Hull'")],
   7: [(0, "'mango_a19'")],
   8: [(3, "'150x150'"), (4, "'/home/ddasilva/tmp/'")],
   9: [],
   10: [  (0, 'True'),
          (1, '43.3643'),
          (2, '3.5238'),
...
_146603564 = DataFactory(name='mango_f21_L.bgeom', 
