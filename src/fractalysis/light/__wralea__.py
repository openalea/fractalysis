...
light_nodes_create_MSS = Factory(name='create MSS', 
                ...
                inputs=({'interface': IStr, 'name': 'Name', 'value': 'myMMS'}, {'interface': None, 'name': 'Scene'}, {'interface': ISequence, 'name': 'Scale table', 'value': None}, {'interface': IEnumStr(enum=('Cvx Hull', 'Sphere', 'Ellipse', 'Box')), 'name': 'Enveloppe type', 'value': 'Cvx Hull'}),
